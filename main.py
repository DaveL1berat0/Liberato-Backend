...
RAPIDAPI_KEY = RAPIDAPI_KEY or os.getenv("x-rapidapi-key") or os.getenv("X_RAPIDAPI_KEY")
RAPIDAPI_HOST = RAPIDAPI_HOST or "ultimate-economic-calendar.p.rapidapi.com"
# FMP (Financial Modeling Prep) — calendario económico, 250 req/día free
FMP_KEY = os.getenv("FMP_KEY") or os.getenv("FMP_API_KEY") or os.getenv("FINANCIAL_MODELING_PREP_KEY")
