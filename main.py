...
async def refresh_institutional():
    ...
    sys_msg = (f"Eres el analista jefe de mesa de Liberato Community para {FA_ASSET} Futures, "
               ...
               "TELEGRÁFICO, cero relleno. Devuelves EXACTAMENTE 6 líneas con este formato (una línea cada una, "
               ...
               "FORMATO: 4 a 6 oraciones en total (una por etiqueta que tenga datos), SIN EMOJIS. Usa las etiquetas en "
               "negrita **Macro:**, **Hoy:**, **Earnings:**, **Técnico:**, **Volatilidad:**, **Claridad:** tal cual, y pon en **negrita** "
    ...
    if has_gamma:
        usr_msg = (f"Datos de mesa ahora mismo:\n\n{ctx_str}\n\n"
                   ...
                   "earnings del Nasdaq, el técnico (GEX/regime/VAH-VAL/precio/tech%/gap), y una línea propia de "
                   "**Volatilidad:** (VIX nivel+dirección, movimiento esperado ±pts, régimen de vol, Fear&Greed). "
