...
def _merge_rapidapi(ff_events, rt_actuals):
    ...
    Matchea por (nombre canónico + fecha) para que 'Unemployment Claims' de FF
    coincida con 'Initial Jobless Claims' de TradingEconomics."""
    def norm(t):
