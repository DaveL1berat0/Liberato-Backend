        ...
        try:
            ...
            async with websockets.connect(uri) as websocket:
                ...
                async for message in websocket:
                    ...
                    # Verificación segura con .get() para evitar KeyError si falta el campo 'event' o 'symbol'
                    if data.get("event") == "price":
                        ...
                        if price_val is not None:
                            ...
                            if symbol_val == "QQQ":
                                # Multiplicador proporcional para reflejar el valor NQ en tu terminal
...
# NUEVO v2: Endpoint unificado "Dashboard" (Líneas 225-235 blindadas)
...
async def startup():
    ...
    # ── CONEXIÓN EN SEGUNDO PLANO DEL WEBSOCKET NATIVO ──
